...
This directory contains materials on Continuous Integration (CI). There are 2 labs in this section, each with versions for both AWS and Azure:
...
- Completed 2 labs on Version Control and Git
